...
private:
	...
	GLuint _vboID;
	GLuint _iboID;
	Shader _rendering_shader{ {{ShaderType::Vertex, "shaders/particle.vert"}, {ShaderType::Fragment, "shaders/particle.frag"}} };
	...
	ComputeShader<256> _update_physics_cs0{ "shaders/update_vel0.comp" };
	ComputeShader<256> _update_physics_cs1{ "shaders/update_vel1.comp" };
	ComputeShader<256> _update_position_cs0{ "shaders/update_pos0.comp" };
	ComputeShader<256> _update_position_cs1{ "shaders/update_pos1.comp" };
